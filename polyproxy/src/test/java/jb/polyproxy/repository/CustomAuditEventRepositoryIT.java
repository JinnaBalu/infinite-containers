package jb.polyproxy.repository;

import jb.polyproxy.PolyproxyApp;

import jb.polyproxy.config.Constants;
import jb.polyproxy.config.audit.AuditEventConverter;
import jb.polyproxy.domain.PersistentAuditEvent;
...
import static jb.polyproxy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
